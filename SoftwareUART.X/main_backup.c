...
void main(void) {
    ...
    while (1) {
        if (PORTAbits.RA0 == 0) { //check pin value to be low
            ...
            //parity check
            rxbyte = rxbuff;
            for (; e < 8; e++) res = ((rxbyte >> e) & 0b00000001) + res;
            if ((res % 2) == 0 && (0b0000000100000000 & rxbuff) == 0b0000000100000000) rxbyte = 0; //error detected
            else if ((res % 2) != 0 && (0b0000000100000000 & rxbuff) != 0b0000000100000000) rxbyte = 0; //error detected
